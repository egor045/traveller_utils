...
from .tables import ANIMAL_ATTRIBUTE_TABLE
from .tables import ANIMAL_TYPES_TABLE
from .tables import SIZE_WEAPONRY_TABLE
from .tables import SUPERTYPE_DM_TABLE
from .tables import WEAPONS_TABLE
...
class Animal(object):
    ...
    def __init__(self, terrain_type, upp=None):
        self.supertype = None
        self.quantity = 1
        self.type = None
        self.weight = 0
        ...
        LOGGER.debug('type(upp) = %s', type(upp))
        try:
...
class Herbivore(Animal):
    ...
    def __init__(self, terrain_type, upp=None):
        super().__init__(terrain_type, upp)
